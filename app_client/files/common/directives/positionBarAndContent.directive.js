//taken from http://ionicinaction.com/blog/ionic-custom-double-subheaders/ and modified to work
angular.module('pm').directive('positionBarsAndContent', function ($timeout) {
    return {
        restrict: 'AC',
